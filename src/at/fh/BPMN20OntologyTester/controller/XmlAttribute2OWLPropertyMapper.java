 ...
 *
 */
public class XmlAttribute2OWLPropertyMapper {

	private final Properties owl2xmlMapping;

	private static XmlAttribute2OWLPropertyMapper theInstance;

	public static XmlAttribute2OWLPropertyMapper getInstance() {
		if (theInstance == null)
			theInstance = new XmlAttribute2OWLPropertyMapper();

		return theInstance;
	}

	private XmlAttribute2OWLPropertyMapper() {
